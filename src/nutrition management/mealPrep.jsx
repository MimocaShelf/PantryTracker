...
function MealPrep() {
    ...
    function renderMealTimeItems(mealTime, mealItems) {
        ...
        if(mealItems.length === 0){
            return <p className="warning-message">You have no ingredients set.</p>
        }
        ...
        return mealItems.map((item, index) => (
            <div key={index} className="row">
                ...
                <div className="right-container">
                    ...
                    <button className="search-bar-button" onClick={() => removePantryItem(item.itemName, mealTime)}>Remove</button>
                </div>
            </div>
        ))
    }
    ...
    function renderRecipes(mealName, recipeList) {
        ...
        if(recipeList === undefined){
            return <div className="mealTimes">
                        <h2>For {mealName}:</h2>
                        <p className="warning-message">No items in meal prep...</p>
                    </div>
        ...
        //Check if the recipe object has no items inside, indicating there was no suitable recipe generated by the Recipe API
            ...
            return <div className="mealTimes">
                        <h2>For {mealName}:</h2>
                        <p className="warning-message">No suitable recipes found...</p>
                    </div>
        }
